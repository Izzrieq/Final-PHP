    ...
    <form action="tambahpelajar.php" method="POST">
        ...
        <caption>TAMBAH PELAJAR</caption>
            <tr>
                ...
                <td> <input type="text" name="id" placeholder="001" required> </td>
            </tr>
            <tr>
                <td class=warna> Nombor NDP </td>
                <td> <input type="text" name="nondp" placeholder="23221101" required> </td>
            </tr>
            <tr>
                <td class=warna> Nama Pelajar </td>
                <td> <input type="text" name="namapelajar" placeholder="Izzrieq Illhan" required></td>
            </tr>
            <tr>
                <td class=warna> Nombor KP</td>
                <td> <input type="text" name="nokp" placeholder="030512140435" required></td>
            </tr>
            <tr>
